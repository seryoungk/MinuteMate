...
const apiKey = process.env.GEMINI_API_KEY || "YOUR_API_KEY_HERE"; // TODO: Use environment variable
...
async function listModels() {
  ...
  try {
    ...
    // console.log("Failed gemini-1.5-flash");
  }
